...
<head>
    ...
    .section {
        ...
        .section:nth-child(2n) {
            background-image: url('images/f1.avif');
        }

        .section:nth-child(3n) {
            background-image: url('images/f3.avif');
        }
    ...
    .noUi-handle {
        ...
        /* Additional styles for the range slider */
        #priceRange {
        width: 81%;
        height: 16%;
        position: relative;
...
<body>
    ...
    <!-- <div class="price-filter">
        <label for="priceRange"><b>Select Price Range:</b></label>
        <div id="priceRange"></div>
        <span id="priceValues"></span>
        <button onclick="filterHotelsByPrice()">Filter</button>
    </div> -->

    <!-- Your sections with background images go here -->
    <?php
    ...
    $sql = "select ROW_NUMBER() over(partition by airline) as rownum, airline, source, destination, image, departure, arrival, class, date, seats, description, price from flight where source = '$from' and destination = '$to' and date = '$date' and seats >= '$guests'";
        ...
        while($row = $result-> fetch_assoc()){
            ...
            echo "<div class='section'>
                    <div class='box1'>
                        ...
                        <div class = 'box3'>
                            <h1>". $row["airline"] ."</h1>
                            <p>From : ". $row["source"] ." &nbsp&nbsp&nbsp To : ". $row["destination"] ."</p>
                            <p>Departing date: ".$row["date"]."</p>
                            <p>Departs at: ".$row["departure"]." Arrives at: ".$row["arrival"]."</p>
                            <p>Seats remaining ".$row["seats"]."</p>
                            <p>".$row["description"]."</p>
                            
                        </div>
                        <div class = 'box4'>
                            <h3>".$row["class"]." : ".$row["price"]."</h3>
                            <a href='loginFlight.php?airline=".$airline."&date=".$date."&from=".$from."&to=".$to."&departure=".$departure."&arrival=".$arrival."&class=".$class."&seats=".$seats."&guests=".$guests."' class='btn2'>Book</a>
                        </div>
    ...
    <script>
        ...
        noUiSlider.create(priceRange, {
            start: [0, 100000], // Initial range values
