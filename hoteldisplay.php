...
<body>
    ...
    $sql = "select name, room, capacity, available, date, price, image, location, description from hotel where date='$date' and location = '$location' and capacity = '$guests' and available > 0";
    ...
    if($result-> num_rows > 0){
        while($row = $result-> fetch_assoc()){
            ...
            <<div class = 'box3'>
                <h2>". $row["name"] ."</h2>
                <p> Room type : ". $row["room"] ."</p>
                <p> Guests : ". $row["capacity"] ."</p>
                <p>". $row["location"] ."</p>
                <p> Available rooms : ". $row["available"] ."</p>
                <p>". $row["description"] ."</p>
            </div>
            <div class='box4'>
                <h3>BDT ". $row["price"] ."</h3>
                <a href='loginhotel.php?name=".$name."&room=".$room."&date=".$date."&location=".$location."&available=".$available."' class='btn2'>Book</a>
            </div>
        </div>
        </div>";
        }
